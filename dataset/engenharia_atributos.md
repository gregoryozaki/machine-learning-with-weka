...
| 41 | Nível de Risco de Desperdício Ambiental | Categórico | Classe | Classe-alvo do dataset | ```baixo / moderado / alto``` | Rack |
...
| 7 | Temperatura de Exaustão / Exhaust Temperature | Relevante | Temperaturas elevadas podem indicar hotspots, ineficiência térmica ou refrigeração inadequada | Hamann, Grishina; Sunkara & Narukulla | Feature | Sim |
...
| 9 | Utilização de CPU | Relevante | Baixa utilização de CPU associada a alta potência pode indicar ociosidade ou desperdício | Shedd, Sommerhalter; Power Sloshing | Feature preditora | Sim |
| 10 | Fan Speed | Relevante | Rotações elevadas aumentam consumo e indicam esforço de refrigeração | Grishina, Yao et al.; Sunkara & Narukulla; Power Consumption Optimization of GPU Server | Feature preditora | Sim |
...
| 13 | Fator de Potência | Relevante | Baixo fator de potência indica uso menos eficiente da energia elétrica e perdas na distribuiçãom| Shedd, Bartolinin| Feature preditora | Sim |
| 14 | ID de Fabricante / SKU | Irrelevanten| Informação estática do hardware. Pode ter relação indireta com eficiência, por isso não é o melhor atributo irrelevante | Grishina, Curtis | Atributo a descartar / substituir | Não |
| 15 | PUE Global — Power Usage Effectiveness | Irrelevante | Métrica de granularidade de datacenter, podendo ocultar ineficiências específicas de rack | Grishina, Sommerhalter; Ferraz; TechRxiv Survey | Atributo a descartar | Não |
...
| 21 | Potência da GPU | Relevante | GPUs são centrais em datacenters de IA e podem dominar o consumo do servidor | Sunkara & Narukulla; Liao et al.; PowerFlow | Feature preditora | Sim |
| 22 | Utilização de GPU | Relevante | Baixa utilização de GPU com alta potência indica subutilização e potencial desperdício | PowerFlow; Shapeshifter; Untangling GPU Power Consumption | Feature preditora | Sim |
| 23 | Temperatura da GPU | Relevante | Representa condição térmica do acelerador e necessidade de refrigeração | Sunkara & Narukulla; Power Consumption Optimization of GPU Server; Untangling GPU Power Consumption | Feature preditora | Sim |
| 24 | Frequência / Clock da GPU | Relevante | Afeta consumo, desempenho e eficiência energética; associada a DVFS e power management | PowerFlow; Power Sloshing; Power Consumption Optimization of GPU Server | Feature preditora | Sim |
| 25 | Número de GPUs | Relevante | Quantidade de GPUs influencia consumo, paralelismo, densidade computacional e energia do job | Liao et al.; PowerFlow; TechRxiv Survey | Feature preditora | Sim |
| 26 | Utilização de Memória | Relevante | Workloads de LLM possuem demandas multidimensionais de memória, computação e potência | Shapeshifter; Liao et al. | Feature preditora | Sim |
| 27 | Tipo de Workload de IA | Relevante | Treinamento, inferência, fine-tuning e ociosidade possuem perfis energéticos e operacionais diferentes | Kang et al.; Power Sloshing; TechRxiv Survey | Feature preditora | Sim |
| 28 | Batch Size | Relevante | Afeta throughput, consumo e comportamento de treinamento | Liao et al.; PowerFlow | Feature preditora | Sim |
...
| 30 | Tamanho do Modelo | Relevante | Modelos maiores tendem a exigir mais computação, memória e energia | Liao et al.; PowerFlow; TechRxiv Survey | Feature preditora | Sim |
| 31 | Quantidade de Amostras de Treinamento | Relevante | Volume de dados de treinamento influencia duração, iterações e consumo | Liao et al.; PowerFlow | Feature preditora | Sim |
| 32 | Duração do Job | Relevante | Jobs mais longos acumulam maior consumo energético e potencial impacto ambiental | Kang et al.; PowerFlow; Liao et al. | Feature preditora | Sim |
| 33 | Throughput de Treinamento | Relevante | Relaciona desempenho com consumo e pode apoiar análise de eficiência energética | PowerFlow | Feature preditora ou métrica auxiliar | Opcional |
| 34 | Energia por Iteração | Derivado / risco de vazamento | Resume diretamente energia por unidade de processamento. Pode aproximar demais a regra de rotulagem | PowerFlow | Métrica auxiliar interna | Apenas internamente |
| 35 | Método de Refrigeração | Relevante | Métodos como ar, refrigeração líquida e imersão alteram eficiência térmica, energia e uso de água | Sunkara & Narukulla; TechRxiv Survey | Feature preditora | Sim |
| 36 | Emissão Estimada de Carbono | Derivado | Estimada a partir de energia e intensidade de carbono. Útil para análise, mas pode causar vazamento se a classe depender diretamente dela | Ferraz; TechRxiv Survey | Métrica auxiliar ou feature com cautela | Opcional |
| 37 | Power Cap / Limite de Potência | Relevante | Limites de potência influenciam desempenho, subutilização e desperdício planejado | Power Sloshing; Power Consumption Optimization of GPU Server | Feature preditora | Opcional |
| 38 | Power Budget / Orçamento de Potência | Relevante | Orçamento energético influencia alocação de jobs e decisões de scheduling | PowerFlow | Feature preditora | Opcional |
| 39 | Taxa de Requisições de Inferência | Relevante para inferência | Volume de requisições altera consumo, carga e demanda de recursos | Shapeshifter; Power Sloshing | Feature preditora | Opcional |
| 40 | Quantidade de Tokens Processados | Relevante para inferência | Tokens processados influenciam demanda computacional, memória e potência em LLMs | Shapeshifter; TechRxiv Survey | Feature preditora | Opcional |
| 41 | Nível de Risco de Desperdício Ambiental | Classe-alvo | Representa a variável a ser prevista pelo modelo de classificação | Os autores | Classe-alvo | Sim |

---

## Versão Final

| ID | Atributo | Nome p/ Dataset - En | Nome p/ Dataset - Pt | Unidade | Tipo | Grupo |
| --- | --- | --- | --- | --- | --- | --- |
|  1 | Potência Real / Active Power                     | `active_power_w`                 | `potencia_ativa_w`                  | W                       | Numérico   | Energético             |
|  2 | Consumo de Energia                               | `energy_consumption_kwh`         | `consumo_energia_kwh`               | kWh                     | Numérico   | Energético             |
|  3 | Water Usage Effectiveness — WUE                  | `water_usage_effectiveness`      | `efetividade_uso_agua`              | L/kWh                   | Numérico   | Ambiental              |
|  4 | Intensidade de Carbono                           | `carbon_intensity_gco2_kwh`      | `intensidade_carbono_gco2_kwh`      | gCO₂/kWh                | Numérico   | Ambiental              |
|  5 | Temperatura de Entrada do Ar / Inlet Temperature | `inlet_temperature_c`            | `temperatura_entrada_c`             | °C                      | Numérico   | Térmico                |
|  6 | Temperatura de Exaustão / Exhaust Temperature    | `exhaust_temperature_c`          | `temperatura_exaustao_c`            | °C                      | Numérico   | Térmico                |
|  7 | Delta T — ΔT                                     | `delta_t_c`                      | `delta_t_c`                         | °C                      | Numérico   | Térmico                |
|  8 | Fan Speed                                        | `fan_speed_rpm`                  | `velocidade_fans_rpm`               | RPM                     | Numérico   | Operacional / Térmico  |
|  9 | Método de Refrigeração                           | `cooling_method`                 | `metodo_refrigeracao`               | N/A                     | Categórico | Térmico                |
| 10 | Utilização de CPU                                | `cpu_utilization_percent`        | `utilizacao_cpu_percentual`         | %                       | Numérico   | Computacional          |
| 11 | Utilização de Memória                            | `memory_utilization_percent`     | `utilizacao_memoria_percentual`     | %                       | Numérico   | Computacional          |
| 12 | Potência da GPU                                  | `gpu_power_w`                    | `potencia_gpu_w`                    | W                       | Numérico   | IA / Energético        |
| 13 | Utilização de GPU                                | `gpu_utilization_percent`        | `utilizacao_gpu_percentual`         | %                       | Numérico   | IA / Computacional     |
| 14 | Temperatura da GPU                               | `gpu_temperature_c`              | `temperatura_gpu_c`                 | °C                      | Numérico   | IA / Térmico           |
| 15 | Frequência / Clock da GPU                        | `gpu_core_frequency_mhz`         | `frequencia_gpu_mhz`                | MHz                     | Numérico   | IA / Operacional       |
| 16 | Número de GPUs                                   | `num_gpus`                       | `numero_gpus`                       | Número absoluto         | Numérico   | Infraestrutura IA      |
| 17 | Tipo de Workload de IA                           | `ai_workload_type`               | `tipo_workload_ia`                  | N/A                     | Categórico | Workload IA            |
| 18 | Batch Size                                       | `batch_size`                     | `tamanho_batch`                     | Número absoluto         | Numérico   | Workload IA            |
| 19 | Número de Épocas                                 | `num_epochs`                     | `numero_epocas`                     | Número absoluto         | Numérico   | Workload IA            |
| 20 | Tamanho do Modelo                                | `model_parameter_size_million`   | `tamanho_modelo_milhoes_parametros` | Milhões de parâmetros   | Numérico   | Workload IA            |
| 21 | Quantidade de Amostras de Treinamento            | `training_samples`               | `amostras_treinamento`              | Número absoluto         | Numérico   | Workload IA            |
| 22 | Duração do Job                                   | `job_duration_hours`             | `duracao_job_horas`                 | Horas                   | Numérico   | Operacional            |
| 23 | Job Status / Exit Code                           | `job_status`                     | `status_job`                        | N/A                     | Categórico | Operacional            |
| 24 | Cor da Etiqueta do Rack                          | `rack_label_color`               | `cor_etiqueta_rack`                 | N/A                     | Categórico | Controle / Irrelevante |
| 25 | Nível de Risco de Desperdício Ambiental          | `environmental_waste_risk_level` | `nivel_risco_desperdicio_ambiental` | baixo / moderado / alto | Categórico | Classe                 |
